...
const Moda = () => {
    ...
    if (cargandoHombre || cargandoMujer) {
        return <h2 className="text-center my-5">...Cargando Moda (Hombre y Mujer)...</h2>;
    }
    ...
    return (
        <div className="container my-4">
            ...
            <h1 className="mb-4 text-center my-4">Catálogo de Moda para  Mujer</h1>
            ...
            <h1 className="mb-4 text-center my-4">Catálogo de Moda para Hombre </h1>

            {/* Grilla para todos los productos de Hombre */}
            <div className="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-4">
