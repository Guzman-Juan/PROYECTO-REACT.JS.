...
const Login = () => {
  ...
  const { login, estaLogiado, usuario: usuarioContexto} = useAuthContext();
  ...
  }, [estaLogiado, usuarioContexto, navigate]);
  ...
  const manejarSubmit = (evento) => {
    ...
    if(usuario == 'admin' && contrasenia == '1234') {
      login(usuario);
      navigate('/admin');
    } else if (usuario == 'nombre' && contrasenia == '1234') {
      login(usuario);
      navigate('/');
    } 
    else { 
      toast('Usuario o Contraseña invalido');
    }
  }
